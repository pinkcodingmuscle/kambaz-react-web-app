...
tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
            <li>Cut the chicken breast into two thinner cutlets (or use 
                thin-cut chicken breasts). </li>
            <li>Season each breast with garlic, salt, black pepper, and 
                curry powder.</li>
            <li>Sprinkle the flour over both sides of the chicken breasts 
                and rub it in until the chicken is evenly coated</li>
            <li>Heat a skillet over medium heat and add olive oil and 
                1 Tbsp of butter.</li>
            <li>Once the skillet is hot, add the chicken and cook on each 
                side until golden brown.</li>
            <li>Once the chicken is removed, to the same skillet add the 
                remaining 1 Tbsp of butter, then add the garlic cloves</li>
            <li>Turn the heat down to medium-low and sauté the garlic for 
                3 minutes or until lightly browned and fragrant.</li>
            <li>Make sure to stir the garlic so it doesn't burn.</li>
            <li>Next pour the chicken broth and heavy cream into the pan 
                and allow the sauce to simmer in the pan for 8-15 minutes</li>
            <li>Return the cooked chicken breasts to the skillet and 
                spoon the creamy sauce over top. Allow the chicken to heat through.</li>
            <li>Finally, serve with rice or another carb side of your choice!</li>
        </ol>
        </div>
        ...
        <ul id="wd-your-books">
            <li>Atomic Habits</li>
            <li>The Awe of God</li>
            <li>The Purpose Driven Life</li>
            <li>Finding God's Will For My Life</li>
    ...
    Please
    <a href="https://github.com/pinkcodingmuscle/kambaz-react-web-app.git" id="wd-github"> click here </a>
    to see my code repository on github<br/>
