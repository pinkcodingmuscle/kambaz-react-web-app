    ...
    return (
      <div id="wd-assignments">
        ...
        <ListGroup className="wd-assignment-list rounded-0" >
          ...
          .map((assignment:any) => (
          <ListGroup.Item key={assignment._id} style={{ borderLeft: "4px solid green" }} className="wd-assignment-list-item d-flex">
            <div className="d-flex align-items-center me-3"> 
              <BsGripVertical className="me-3 fs-3" />
              </div>
            <div style={{color:"green"}}className="d-flex align-items-center me-3"> 
              <LuNotebookPen className="me-3 fs-3" />
              </div>
